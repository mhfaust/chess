 ...
 * @returns 
 */
const maxLength = (max: number, errMessage: string) => makeValidationFn<string>(input => input.length <= max, errMessage);
 ...
 * @returns 
 */
const minLength = (min: number, errMessage: string) => makeValidationFn<string>(input => input.length >= min, errMessage);

const lengthRange = (min: number, max: number, errMessage: string) => combineValidators(
