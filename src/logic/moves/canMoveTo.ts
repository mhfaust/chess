import { bishopCanMove, kingCanMove, knightCanMove, pawnCanMove, queenCanMove, rookCanMove } from '@/logic/moves';
...
export type CanMoveTo = (...params: Parameters<typeof canMoveTo>) => boolean;
